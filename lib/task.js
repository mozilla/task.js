...
Wait.prototype = {
    ...
    /**
     * @override function(Task) : void
     * @throws never
     */
    onYield: function(task) {
        this.block(task);
        task.blockedOn = this;
        this.onBlock();
    },
...
function started() {
    ...
    try {
        if (!this.isBlocked()) {
            ...
            if (yielded && typeof yielded === "object" && typeof yielded.onYield === "function")
                yielded.onYield(this);
        }
        schedule(this);
    } catch (e) {
        if (e !== StopIteration)
            this.result = { value: e, "throw": true };
        shutdown(this);
    }
}
...
Finish.prototype = {
     ...
     */
    onYield: function(task) {
        task.result = { value: this.result, "throw": false };
        //shutdown(task);
        task.stop();
    }
};
