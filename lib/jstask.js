...
(function() {
    ...
    Task.prototype = {
        ...
        start: function() {
            ...
            withCurrent(this, function() { generator.next() });
        },
        stop: function() {
        ...
        resume: function(x) {
            ...
            var generator = this.generator;
            withCurrent(this, function() { generator.send(x) });
        },
        throw: function(x) {
            this.checkInactive("resume");
            var generator = this.generator;
            withCurrent(this, function() { generator.throw(x) });
        }
    };
})();
